...
namespace NinjaTrader.NinjaScript.DrawingTools
{
	...
	public class Line : DrawingTool
	{
		...
		private sealed class LineKeyEvent
		{
			public		ChartControl		chartControl				= null;
			public		ChartPanel			chartPanel					= null;
			public		ChartScale			chartScale					= null;
			public		ChartAnchor			cursorDataPoint				= null;
			public		bool				isAnchorModifedByKey		= false;
			public		bool				isKeyEventHandled			= false;
			
			public void InitLineKeyEventHandling(ChartControl chartControl, ChartScale chartScale, KeyEventHandler onKeyDown, KeyEventHandler onKeyUp)
			{
				...
				chartControl.PreviewKeyUp	+= onKeyUp;
			}
			public void UnsubscribeHandlers(KeyEventHandler onKeyDown, KeyEventHandler onKeyUp)
			{
		...
		private readonly LineKeyEvent lineKeyEvent = new LineKeyEvent();
		...
		public override void OnMouseMove(ChartControl chartControl, ChartPanel chartPanel, ChartScale chartScale, ChartAnchor dataPoint)
		{
			...
			lineKeyEvent.cursorDataPoint = dataPoint;
		...
		public void OnPreviewKeyDownUp(object sender, System.Windows.Input.KeyEventArgs e)
		{
			if ((e.Key == Key.LeftShift || e.Key == Key.RightShift) &&
				LineType != ChartLineType.HorizontalLine &&
				LineType != ChartLineType.VerticalLine)
			{
				OnMouseMove(lineKeyEvent.chartControl, lineKeyEvent.chartPanel, lineKeyEvent.chartScale, lineKeyEvent.cursorDataPoint);
				ForceRefresh();
			}
		}
		...
		public override void OnRender(ChartControl chartControl, ChartScale chartScale)
		{
			...
			if (!lineKeyEvent.isKeyEventHandled)
				lineKeyEvent.InitLineKeyEventHandling(chartControl, chartScale, OnPreviewKeyDownUp, OnPreviewKeyDownUp);
		...
		protected override void OnStateChange()
		{
			...
			{
				if (lineKeyEvent != null && lineKeyEvent.isKeyEventHandled)
					lineKeyEvent.UnsubscribeHandlers(OnPreviewKeyDownUp, OnPreviewKeyDownUp);
